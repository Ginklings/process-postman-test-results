...
var require_utils6 = __commonJS({
  'src/utils.js'(exports2, module2) {
    ...
    var fs2 = require('fs');
    async function readJsonResultsFromFile2(resultsFile) {
      core2.info('Reading results from postman results file....');
      if (fs2.existsSync(resultsFile)) {
        const rawJson = fs2.readFileSync(resultsFile, 'utf8');
        if (!rawJson) {
          core2.info(
        ...
        core2.setFailed(`The results file '${resultsFile}' does not exist.  No status check or PR comment will be created.`);
        return;
      }
    }
    module2.exports = {
...
var require_markup = __commonJS({
  'src/markup.js'(exports2, module2) {
    ...
    function getMarkupForJson2(jsonResults, reportName) {
      return `
# ${reportName}
...
var resultsFileList = core.getInput('results-file', requiredArgOptions);
